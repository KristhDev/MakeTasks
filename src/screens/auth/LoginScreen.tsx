        ...
        >
            ...
            >   
                ...
                <View 
                    style={{ 
                        ...styles.background,
                        height: (height > width) ? windowHeight * 0.75 : width * 0.7,
                        left: (height > width) ? -width * 0.95 : -windowHeight * 0.40,	
                        width: (height > width) ? width * 2.3 : windowHeight * 2.6,
                        bottom: (height > width) ? -windowHeight * 0.10 : -width * 0.2,
                    }}
                >
                    { /* Fondo más pequeño */ }
                    <View 
